...
const getEmployees = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        res.json({ message: " Error in Getting Employee" });
    }
    ...
    upload(req, res, async function (err) {
        if (err instanceof multer.MulterError) {
            ...
            if (
                ...
                res.status(400);
                console.error('Missing fields:', { salutation, firstName, lastName, email, phone, dob, gender, qualification, address, country, state, city, pin });
